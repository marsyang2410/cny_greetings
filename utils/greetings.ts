...
const greetings: Record<GreetingCategory, string[]> = {
  ...
  英文: [
    ...
    "Happy the Year of the Snake！",
    "Wish you good luck in the Year of the Snake！",
    "Wishing you prosperity and happiness in the Snake Year.",
    "May the Snake bring you good fortune and success.",
    "May the Year of the Snake bless you with the ability to adapt and thrive in any situation.",
    "May you shed your old skin and emerge stronger and wiser this year of the snake.",
    "Wishing you a year of growth and prosperity in the Year of the Snake.",
  ],
};
